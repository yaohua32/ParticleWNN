# /*
#  * @Author: yaohua.zang 
#  * @Date: 2023-09-29 16:34:15 
#  * @Last Modified by:   yaohua.zang 
#  * @Last Modified time: 2023-09-29 16:34:15 
#  */
import numpy as np 
import torch 
import scipy.io
...
class Problem(Module.Problem):
    ...
    def get_test(self, t_start_loc:int=0, t_end_loc:int=201)->torch.tensor:
        '''
        Input:
        ...
        #
        True_data = scipy.io.loadmat('./Problems/data/allen_cahn_1d.mat')
        t_mesh = True_data['tt'].flatten()
    ...
    def fun_bd(self, model:torch.nn.Module, x_list:list[torch.tensor], 
        ...
        #
        cond_list.append(u_lb_nn - u_ub_nn)
        cond_list.append(du_lb_nn - du_ub_nn)
    ...
    def fun_init(self, model:torch.nn.Module, 
        ...
        '''
        u_init_nn = model(x, t)
        u_init = x**2 * torch.cos(self._freq * x)
    ...
    def strong_pinn(self, model:torch.nn.Module, x:torch.tensor,
        ...
        ##############
        eq = dut + 5.*(u**3 -u) - self._lambda*Lu
